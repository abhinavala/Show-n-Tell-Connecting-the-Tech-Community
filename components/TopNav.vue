        ...
        >
            <div :class="route.fullPath === '/' ? 'w-[80%]' : 'lg:w-[20%] w-[70%]'">
                <NuxtLink to="/">
                    <div class="flex items-center">
                        <Icon name="mdi:code-braces" size="40" color="#3B82F6" class="mr-2"/>
                        <span class="text-2xl font-bold text-gray-800">Show n Tell</span>
                    </div>
                </NuxtLink>
            </div>
            ...
            <div class="hidden md:flex items-center bg-[#F1F1F2] p-1 rounded-full max-w-[380px] w-full ">
                <input 
                    ...
                    placeholder="Search projects, developers, or skills..."
                >
            ...
            <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
                ...
                >
                    ...
                    <span class="px-2 font-medium text-[15px]">Showcase Project</span>
                </button>

                <div v-if="!$userStore.id" class="flex items-center">
                    <button 
                        @click="$generalStore.isLoginOpen = true" 
                        class="flex items-center bg-[#3B82F6] text-white border rounded-md px-3 py-[6px]"
                    >
